...
!!! tip "Dive deeper"
    ...
    Read the [architecture decisions](https://github.com/EthanMBoos/maf_aerial/blob/main/docs/ARCHITECTURE_DECISIONS.md) for the PX4-centered model, or [runtime composition](https://github.com/EthanMBoos/maf_aerial/blob/main/docs/RUNTIME_COMPOSITION.md) for the two-process layout and promotion criteria for further splits.
